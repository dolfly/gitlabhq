...
RSpec.describe AddNotNullConstraintToNamespacesState, feature_category: :groups_and_projects do
  it 'adds a NOT NULL constraint to the state column' do
    ...
    expect(Gitlab::Database::PostgresConstraint.check_constraints.by_table_identifier('public.namespaces'))
      .to include(have_attributes(name: 'check_9d490f2140', definition: 'CHECK ((state IS NOT NULL))'))
  end
