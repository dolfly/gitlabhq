...
| `geo_project_import_export_relation_export_upload_uploads`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads on primary |
| `geo_project_import_export_relation_export_upload_uploads_checksum_total`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads to checksum on primary |
| `geo_project_import_export_relation_export_upload_uploads_checksummed`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads that successfully calculated the checksum on primary |
| `geo_project_import_export_relation_export_upload_uploads_checksum_failed`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads failed to calculate the checksum on primary |
| `geo_project_import_export_relation_export_upload_uploads_synced`| Gauge     | 19.0 | `url`                                                                                     | Number of syncable relation export file uploads synced on secondary |
| `geo_project_import_export_relation_export_upload_uploads_failed`| Gauge     | 19.0 | `url`                                                                                     | Number of syncable relation export file uploads failed to sync on secondary |
| `geo_project_import_export_relation_export_upload_uploads_registry`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads in the registry |
| `geo_project_import_export_relation_export_upload_uploads_verification_total`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads to attempt to verify on secondary |
| `geo_project_import_export_relation_export_upload_uploads_verified`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads successfully verified on secondary |
| `geo_project_import_export_relation_export_upload_uploads_verification_failed`| Gauge     | 19.0 | `url`                                                                                     | Number of relation export file uploads that failed verification on secondary |
